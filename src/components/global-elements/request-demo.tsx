...
import { usePreFooterDemoFormQuery } from "../../graphql/usePreFooterDemoFormQuery";
...
const RequestDemo = () => {
  ...
  // global demo form
  const {allWpGlobalElement} = usePreFooterDemoFormQuery();
  const demoForm = allWpGlobalElement.nodes[0].globalDemoForm.demoForm;
