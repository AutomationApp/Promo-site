...
const GlobalCaseStudyItem = ({ data }) => {
  return (
    <div className="row">
            ...
            <div className="col-12 col-md-6">
              <div className="card-img-slider">
                <div
                  ...
                  style={{
                    backgroundImage: `url("${data.image.sourceUrl}")`,
                  }}
                >
                  <img
                    ...
                    <div className="w-100 is-selected">
                      ...
                      <div className="card-meta mt-auto">
                        ...
                        <div className="avatar avatar-sm mr-2">
                          <img
                            src={data.image.author.node.avatar.url}
                            alt="Person"
                        ...
                        <h6 className="text-uppercase text-muted mr-2 mb-0">
                          {data.image.author.node.name}
                        </h6>

                        <p className="h6 text-uppercase text-muted mb-0 ml-auto">
                          <time dateTime="2019-05-02">
                            {moment(data.image.date).format("MMM d")}
                          </time>
                        </p>
                      </div>
                    </div>
...
export default GlobalCaseStudyItem;
