        ...
        <div className="row align-items-center gy-5">
          <div className="col-12 col-md-6 col-lg-5" data-aos="fade-up">
            ...
            <p className="font-size-lg text-gray-700">
              Using Automation.app you can streamline communication and build a
              set of structured flows that runs a large part of your daily
              business.
            </p>
                ...
                <div className="list-group list-group-flush">
                  <div className="list-group-item d-flex align-items-center">
                    <div className="mr-auto">
                      ...
                      <p className="font-size-sm text-muted mb-0">
                        Simple complete solution for handling orders, customers
                  ...
                  <div className="list-group-item d-flex align-items-center">
                    <div className="mr-auto">
                      ...
                      <p className="font-size-sm text-muted mb-0">
                        Your needs are our command. Send us an email to get your
                        feature online
                      </p>
                    </div>
